...
var.setTerm("urn:sedml:analysis:controlCoefficient:scaled")
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:controlCoefficient:unscaled")
var.setSymbol("urn:sedml:symbol:amount")
var.setTarget(ovar.getTarget())
var.setTarget2(ovar.getTarget().replace("S1", "X0"))
sedml.addDataGenerator(datagen)
...
#Elasticity coefficient of J1 wrt. Vmax
datagen = sedml.createDataGenerator()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:elasticity:scaled")
var.setTarget("/sbml:sbml/sbml:model/sbml:listOfReactions/sbml:reaction[@id=&apos;J0&apos;]")
var.setTarget2("/sbml:sbml/sbml:model/sbml:listOfParameters/sbml:parameter[@id=&apos;Vmax&apos;]")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
...
#Unscaled elasticity coefficient of J1 wrt. Vmax
datagen = sedml.createDataGenerator()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:elasticity:unscaled")
var.setTarget("/sbml:sbml/sbml:model/sbml:listOfReactions/sbml:reaction[@id=&apos;J0&apos;]")
var.setTarget2("/sbml:sbml/sbml:model/sbml:listOfParameters/sbml:parameter[@id=&apos;Vmax&apos;]")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:jacobian:reduced")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:eigenvalues:full")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:eigenvalues:reduced")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:controlCoefficientMatrix:scaled:concentration")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("sc_c")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:controlCoefficientMatrix:unscaled:concentration")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("uc_c")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:controlCoefficientMatrix:scaled:flux")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("sf_c")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:controlCoefficientMatrix:unscaled:flux")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("uf_c")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:elasticityMatrix:scaled")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("sEs")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:elasticityMatrix:unscaled")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("uEs")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:stoichiometryMatrix:reduced")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:linkMatrix")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("lmat")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:kernelMatrix")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("kmat")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:L0Matrix")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("kmat")
datagen.setMath(astn)
...
var.setTaskReference("task0")
var.setModelReference("model0")
var.setTerm("urn:sedml:analysis:NrMatrix")
sedml.addDataGenerator(datagen)
astn = libsedml.ASTNode()
astn.setName("kmat")
datagen.setMath(astn)
